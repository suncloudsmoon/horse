...
struct compl {
 int (*compl_main) (int argc, char **argv);
 ...
 void (*compl_list_complete_remove) (void *indivfree);
 void (*compl_list_clear) (list_t *list);
 bool (*compl_list_equals) (void *destComp, int index, bool *equalsComparator);
 bool (*compl_list_contains) (void *destComp, bool *equalsComparator);
 void (*compl_list_serialize) (void *indiv);
 list_t* (*compl_list_deserialize) (void* *indivreverse);
 void (*compl_list_free) (list_t *list);
 void (*compl_list_complete_free) (void *indivfree);
